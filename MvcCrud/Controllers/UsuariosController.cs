...
namespace MvcCrud.Controllers
{
    public class UsuariosController : Controller
    {
            ...
            int? pageNumber)
        {
            ...
            {
                usuarios = usuarios.Where(s => s.Correo!.Contains(searchString));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellidos,Correo,Clave,TipoUsuario")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellidos,Correo,Clave,TipoUsuario")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
